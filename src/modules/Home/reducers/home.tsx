...
import {CHANGE_MAIN_SLIDE, DISANIMATE_MAIN_SLIDER} from '../constants/home';
...
export default handleActions({
	[CHANGE_MAIN_SLIDE]: (state: any, {payload}) => {
		const steps = state.currentSlideIndex < payload
			...
			: state.mainSlides.length - state.currentSlideIndex + payload;
	...
	[DISANIMATE_MAIN_SLIDER]: (state: any) => ({
		...state,
		isMainSliderAnimated: false,
	}),
}, initialState);
